  ...
  content:
    text: |-
        ...
        * [gdoc to read](https://docs.google.com/document/d/1_vOftBnrk9NRk5h10UqrfJ5CDih9KBKL61yvrZtVWPE/edit?pli=1)
        ...
        Here is a [list of frameworks](https://llm.extractum.io/gpu-hostings/) for LLM inference.

        Some popular frameworks for model deployment include *vLLM, TensorRT (tensorrt-llm), Deepspeed*.
        ...
        To improve the throughput/latency, we can also leverage quantization techniques. Usually, these techniques enable people to use a model using less memory (which primarily aim to enable GPU poors to just train/infer a model).

        This [link](https://oobabooga.github.io/blog/posts/gptq-awq-exl2-llamacpp/) provides a comparison of the different quantization techniques. Generally, AWQ < GPTQ.
        ...
        ## Multi-modality and agentic systems

        Some insights on GPT4-V model on image processing is described in this [link](https://platform.openai.com/docs/guides/vision). Some of the interesting OSS ViTs (in late 2023) are CogVLM, Adept Fuyu, MiniGPT, BLIP-2, LlaVa-1.5. A more recent summary of Vision-Language models is provided in a [paper](https://arxiv.org/pdf/2405.17247) from Meta (24/05/2024)
        ...
        Other techniques try to combine LLMs and browser softwares, such as [GPT4-V Act](https://github.com/ddupont808/GPT-4V-Act/issues/4), which uses vision with [CSSOM](https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect) (CSS version of DOM).
        ...
        ## A brief insight of the biggest generative models
